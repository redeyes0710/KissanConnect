...
export const DEMO_SUMMARY = {
  ...
  totalRevenue: DEMO_ORDERS.reduce((sum, o) => sum + o.total_price, 0),
  pendingOrders: DEMO_ORDERS.filter((o) => o.status === "pending").length,
  confirmedOrders: DEMO_ORDERS.filter((o) => o.status === "confirmed").length,
  completedOrders: DEMO_ORDERS.filter((o) => o.status === "completed").length,
  totalFarmers: 3,
  totalBuyers: 3,
};
